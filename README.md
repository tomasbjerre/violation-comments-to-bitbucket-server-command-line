...
[![Build Status](https://travis-ci.org/tomasbjerre/violation-comments-to-bitbucket-server-command-line.svg?branch=master)](https://travis-ci.org/tomasbjerre/violation-comments-to-bitbucket-server-command-line)
[![Bintray](https://api.bintray.com/packages/tomasbjerre/tomasbjerre/se.bjurr.violations%3Aviolation-comments-to-bitbucket-server-command-line/images/download.svg) ](https://bintray.com/tomasbjerre/tomasbjerre/se.bjurr.violations%3Aviolation-comments-to-bitbucket-server-command-line/_latestVersion)
...
-comment-template <string>                              <string>: any string
                                                        Default: See: https://github.com/tomasbjerre/violation-comments-lib
